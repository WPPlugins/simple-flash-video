...
<script type="text/javascript" src="<?php echo $plugin_url ?>/yui-utilities.js"></script>
<script type="text/javascript" src="<?php echo $plugin_url ?>/shadowbox-yui.js"></script>
<script type="text/javascript" src="<?php echo $plugin_url ?>/shadowbox.js"></script>
...
<script type="text/javascript">window.onload = function(){
	 ...
	 var options = {
		...
		animSequence: 		"sync",
		counterType:		"skip",
		loadingImage:	   "<?php echo $plugin_url ?>/loadingAnimation.gif"
...
<!-- End of Simple Flash Video Plugin -->
	...
	*/
	...
	{				
		...
		$config_settings = array("CONFIG" => '0',"HEIGHT"=> '0', "WIDTH"=> '0', "OVERSTRETCH"=> '0', "FULLSCREEN"=> '0', "AUTOSTART"=> '0', "BUFFERLENGTH"=> '0', "REPEAT"=> '0', "QUALITY"=> '0', "VOLUME"=> '0', "SHUFFLE"=> '0', "CONTROLBAR"=> '0', "PLAYLIST"=> '0', "PLAYLISTSIZE"=> '0', "MUTE"=> '0', "STRETCHING"=> '0', "CHANNEL"=> '0', "FULL_PLUGIN_URL"=> '0', "REMOVE_PADDING"=> '0', "STREAMER"=> '0', "BACKCOLOR"=> '0', "FRONTCOLOR"=> '0', "LIGHTCOLOR"=> '0', "SCREENCOLOR" => '0', "SKIN"=> '0', "BOTR" => '0', "BITS_THUMB_SIZE"=> '0', "DEFAULT_CLICK_TITLE"=> '0', "LONGTAILNUMBER"=> '0', "LONGTAILENABLE" => '0', "DEFAULT_VID_IMAGE" => '0', "IMAGE" => '0', "LOGO" => '0', "CAPTIONS" => '0', "DISPLAYCLICK" => '0' , "LINKTARGET" => '0', "PLUGINS" => '0', 'ENABLE_META_TAGS' => '0');
	...
	function FlashVideo_Render($matches) 
	{
		...
		$output .= "\n" . '<a href="' . htmlspecialchars( $plugin_url . '/video.php?');
